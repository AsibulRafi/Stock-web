          ...
          <div className="terms__content-scrollbar">
            <div className="terms__content-scrollbar-wrapper">
              ...
              <p>
                ...
                written consent of No name 1. However, it is permissible to use
                ...
                that any other usage of the contents found on No name 1 is not
                allowed without permission.
              </p>
              <h4>Usage of information and other files</h4>
              <p>
                All of the information and rules contained on the website might
                be changed at some point in time. The usage of No name 1 and its
                ...
                certain aspects of the website. No name 1 saves its right to be
              ...
              <p>
                ...
                “as they are” and are all part of the No name 1 platform, but No
                name 1 is not liable for the correctness or consistency of the
                materials. Along with that,No name 1 is not liable for any
              ...
              <p>
                ...
                related to No name 1 . Therefore, No name 1 is not liable for
                ...
                pages or use any of their products or services. No name 1 holds
                no liability towards any issues that might arise from going to
                those websites. Also, be warned that No name 1 is not liable for
                the security level of those 3rd party websites and the terms and
                conditions of use will most likely be different. All of the data
                and information that is here is not strictly related to the
                ...
                decisions and judgment. No name 1 is not obliged to contain the
                ...
                future if you`ve been profitable in the past. No name 1 is not
              ...
              <p>
                No name 1 will not be held liable for any harmful actions,
                ...
                will also not be accounted for byNo name 1 . This is true even
                if No name 1 or its partners influenced the user in any way to
              ...
              <p>
                ...
                belong to No name 1 . No name 1 will reveal any information only
                if there is an inquiry by a body of the law or if there is a
                mutual agreement with the requesting party. However, the
                abovementioned things do not mean that No name 1 does not have
                any relation or duty towards its users regarding the user
                privacy terms.
              </p>
              <h4>Expiry of the profile</h4>
              <p>
                No name 1 is entitled to take a monthly tax of $36 in case the
                ...
                less than $36 on the user profile, No name 1 can use the
                available funds to cover the fee and then bring the account to
                closure.
              </p>
              <h4>Cancellation of the agreement</h4>
              <p>
                The relationship between No name 1 and the user can be canceled
              ...
              <p>
                ...
                access to the No name 1 platform are also strictly forbidden.
              ...
              <ul>
                ...
                <li>
                  No name 1 reserves the right to decide whether a user is
                ...
                <li>
                  ...
                  granted a bonus, please contact No name 1 and we will fix the
                  issue.
                </li>
              </ul>
              <p>
              ...
              <p>
                We at No name 1 look for many ways to provide a competitive and
              ...
              <p>Now the Latest Promotion till the end of No name 1</p>
              ...
              <p>
                This agreement is made by the user and the No name 1 platform,
              ...
              <p>
                ...
                trading at No name 1 , some might be made available at certain
                points only. Direct engagement: No name 1 and the user engage in
                this contract by their own free will, as individuals, entities
                or a related party. If this is not the case, it should be put
                into a written explanation.No name 1 will not verify and accept
                any user actions which have not been approved and shared with
                beforehand. The user provides his consent to provide No name 1
                with any relevant information that might be requested. Margin:
                We`ve already stated that the usage of the platform might
                include some margined transactions, that might need the customer
                to put funds to meet the obligations stated in the agreement.
                There isn`t any solicitation: No name 1 has never encouraged or
                suggested in any way and form that users should engage in any
                transactions or make a purchase of an asset. Also, No name 1 is
                not liable for the same actions done by any 3rd parties related
                to the platform. Mistakes: There are many things that might
                result in an error in the quotation, along with 3rd parties and
                other things. No name 1 keeps its privilege to make changes to
                an account balance if there happens to be a payment a mistake in
              ...
              <p>
                ...
                processing the payment, No name 1 must verify that the person
                making the deposit is the real user of that account. In case
                this is not true, No name 1 can decide to cancel the transfer.
                No name 1 is not liable for any money not deposited straight to
              ...
              <p>
                ...
                No name 1 has the privilege to stop or negate any transfer or
              ...
              <p>
                ...
                regarding the Contract for Difference. It states that No name 1
                shall begin a trade as late as 5 minutes after the certain
                market has been opened. No name 1 holds the privilege to deny a
                trade of a relevant asset within those 5 initial minutes.
                Also,No name 1 can decide to terminate or not process any trade
              ...
              <p>
                ...
                certain navigations by No name 1, be it in oral or written form.
                The navigation in written form might be sent by fax, phone,
                e-mail, formal request, it might be located somewhere on the
                platform or in any other informative digital medium. The regular
                oral means of providing users with information is on the phone
                or a personal notification. In such cases, No name 1 might ask
                the user to write down the provided directions. The
                notification/order/instruction can be canceled only if No name 1
                agrees to it. No name 1 has the right to change or give new
                directions to the user at any point in time.
              </p>
              <p>
                No name 1 has the right to change or give new directions to the
                user at any point in time. Once No name 1 contacts a user in
                ...
                allowed in written form by No name 1. The truthfulness of all
                ...
                No name 1 has to confirm or take action based on the provided
                ...
                directions to No name 1 regarding an open position before the
                end of the trading day has come. No name 1 has the right to move
                the pending trades to the following day. However, this is not a
                must and it`s up to No name 1 to decide. If there is a trade
                that has been moved to the next trading day, the user will be
                charged with 0.01% of his profile balance. The charge will
                ...
                charges against No name 1 in case of any funds loss or other
                ...
                guidelines provided online byNo name 1. This also includes that
                the user should not pursue No name 1 if the user did not seek
                further information or instructions fromNo name 1 regarding an
                issue, or any previous instructions or any actions whatsoever.
                No name 1 is also not liable for any harm done by anyone
              ...
              <p>
                No name 1 has given you all the necessary papers and terms
                ...
                put in. The user does not have any ongoing trades at No name 1.
              ...
              <p>
                ...
                middlemen) and the user agrees to that. No name 1 also has a
                ...
                card and in USD. It is possible that No name 1 will not accept a
                certain transfer or an application for using other means for the
                transferal. In cases when the customer wants to use another
                ...
                Money Laundering Regulations. In some cases, No name 1 might ask
                for further information regarding the source of the money and
                the recipient.
              </p>
              ...
              <p>
                ...
                prevents him from using the No name 1 platform.
              </p>
              <p>
                ...
                be its representative in front of No name 1. Matter of the
                ...
                given by No name 1 is correct and rightful and has not caused
              ...
              <p>
                ...
                respective amount in the currency required by No name 1. Prior
                to executing a trade, No name 1does not have to make sure that
                the user has the necessary safety leeway. Also, if No name 1
                ...
                user or parties associated with him. Also, No name 1 is not
                ...
                agreement and along with any guidelines which No name 1 has
                imposed in order to be able to perform its duties under such an
                agreement. No name 1 does not necessarily have to, but on some
                occasions, it might exchange user funds into a different
                currency, at a rate favorable for the platform in order to cover
                some user liabilities or credits. No name 1 can start or end any
                trades without having to inform the user before that and cover
                any user obligations towards the platform if the user does not
                succeed in covering the obligations himself. Also, No name 1
                holds the privilege to give back and money without having to
                explain the basis for the return.
              </p>
              <h2>Spread Rate, Margin, and Leverage</h2>
              <p>
                No name 1 can change the safety margin terms depending on the
                number of the user`s trades, transfers and economic climate
                (including but not only depending on bad liquidity and
                volatility). Other criteria might also apply. No name 1 also has
                the privilege to make changes to the spread rate depending on
                the user`s safety margin and trades. The user should take care
                of checking his profile activities and safety margin by himself.
                Those specifications can be given out by No name 1 after the
                user makes a request on the platform.
              </p>
              <h2>Right of Commitment, Claim, Set-Off, and Withholding</h2>
              <p>
                If No name 1 deems it necessary, it has the right to put
                ...
                No name 1 has the right of commitment and claim, along with a
                right of withholding assets under the user`s name, along with
                other assets or deposits of some kind made to No name 1,
                regardless of any specifics such as maturity dates, currencies
                and so on.
              </p>
              <h2>1. Default</h2>
              <p>
                No name 1 has the privilege to partially or fully end any trade
              ...
              <p>
                ...
                at No name 1, in order to gain an unfair trading advantage. If
                ...
                will be closed as seen fit by No name 1 when the end of the
                ...
                No name 1. If No name 1 decides that it is of importance for the
                safety of platform and its partners. No name 1 holds the
              ...
              <p>
                No name 1 is not responsible for any harm, accidents, financial
              ...
              <p>
                ...
                permission from the appropriate No name 1 employee. A No name 1
                client support employee does not have the authority to make any
                changes to this agreement. The user also agrees that No name 1
                might make changes to the contract and will inform the user via
                email or platform notification. The client expresses his
                agreement regarding the changed conditions by continuing to use
                the platform.
              </p>
              <h2>5. Area of Authority</h2>
              <p>
                The stated terms shall be understood according to the laws of
                the Republic of No name 1. The client accepts to comply with the
                area of authority of the No name 1 regarding any issues and
                matters of the law regarding the agreement and all terms stated
                on No name 1. All parties concur that the No name 1 for the
              ...
              <p>
                ...
                of No name 1 regarding any issues and matters of the law
                regarding the agreement and all terms stated on No name 1. All
                parties concur that theNo name 1 is not valid and applicable.
              </p>
              ...
              <p>
                ...
                No name 1 after the user presents the proper documentation. No
